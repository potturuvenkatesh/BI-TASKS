function submitForm() {
    ...
    var video = document.getElementById('audio').files[0];
    ...
    if (audio) {
        ...
        audioPreviewoPreview.autoplay = true;
        audioPreview.style.maxWidth = '100%';
        audioPreview.style.height = 'auto';
        audioPreview.style.marginTop = '20px';
        newData += "<p><b>Audio:</b></p>";
        newData += "<div class='card-body-audio'>" +
          "<audio class='audio-preview' src='" + audioPreview.src + "' controls autoplay></audio>" +
          "</div>";
      }
